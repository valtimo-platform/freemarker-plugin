...
import {BuildingBlockManagementParams, CaseManagementParams, Page} from '@valtimo/shared';
...
export class GenerateMailContentComponent extends GenerateTemplateConfigurationComponent {
    readonly keyFieldName = 'mailTemplateKey';
    readonly defaultProcessVariableName = 'content';
    readonly descriptionKey = 'generateMailContentDescription';
    readonly keyTitleKey = 'mailTemplateKey';
    readonly keyTooltipKey = 'mailTemplateKeyTooltip';
    ...
    protected fetchTemplates(
        ...
        return this.templateService.getAllMailTemplates(caseParam, buildingBlock);
    }
}
