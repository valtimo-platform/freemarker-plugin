...
export class TextTemplateConfigurationComponent
  implements PluginConfigurationComponent, OnInit, OnDestroy
{
  @Input() save$!: Observable<void>;
  @Input() disabled$!: Observable<boolean>;
  @Input() pluginId!: string;
  @Input() prefillConfiguration$!: Observable<TextTemplateConfig>;
  ...
  private readonly formValue$ = new BehaviorSubject<TextTemplateConfig | null>(null);
  ...
  formValueChange(formValue: TextTemplateConfig): void {
    this.formValue$.next(formValue);
    this.handleValid(formValue);
  }

  private handleValid(formValue: TextTemplateConfig): void {
