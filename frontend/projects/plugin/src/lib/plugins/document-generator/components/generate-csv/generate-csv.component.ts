        ...
        merge(caseParams$, buildingBlockParams$).pipe(
            ...
            switchMap(params => {
                if (params!.managementContext === 'case') {
                    return this.templateService.getAllTemplates((params as any).caseParams, null, 'csv');
                } else if (params!.managementContext === 'buildingBlock') {
                    return this.templateService.getAllTemplates(null, (params as any).buildingBlockParams, 'csv');
                } else {
