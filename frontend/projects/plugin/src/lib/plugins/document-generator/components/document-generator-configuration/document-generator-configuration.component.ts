...
@Component({
  standalone: false,
  selector: 'valtimo-document-template-configuration',
  templateUrl: './document-generator-configuration.component.html',
})
export class DocumentGeneratorConfigurationComponent
  implements PluginConfigurationComponent, OnInit, OnDestroy
{
  @Input() save$!: Observable<void>;
  @Input() disabled$!: Observable<boolean>;
  @Input() pluginId!: string;
  @Input() prefillConfiguration$!: Observable<DocumentTemplateConfig>;
  ...
  private readonly formValue$ = new BehaviorSubject<DocumentTemplateConfig | null>(null);
  ...
  private handleValid(formValue: DocumentTemplateConfig): void {
